...
class feedback_item_textarea extends feedback_item_base {
    ...
    public function build_editform($item, $feedback, $cm) {
        ...
        $itemlength = isset($width_and_height[2]) ? $width_and_height[2] : 8192;
    ...
    public function complete_form_element($item, $form) {
        ...
        list($cols, $rows, $length) = explode ("|", $item->presentation);
        $form->add_form_element($item,
            ['textarea', $inputname, $name, array('rows' => $rows, 'cols' => $cols, 'maxlength' => $length)]);
