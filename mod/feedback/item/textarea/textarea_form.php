...
class feedback_textarea_form extends feedback_item_form {
    ...
    public function definition() {
        ...
        /* LEAFNET: create field for max length */
        $mform->addElement('text',
            'itemmaxlength',
    ...
    public function get_data() {
        ...
        /* amend to include maxlength code */
        if (!isset($item->itemmaxlength)){
            $item->itemmaxlength = 8192;
        }

        $item->presentation = $item->itemwidth . '|'. $item->itemheight . '|'. $item->itemmaxlength;
